...
def preprocess(imgOriginal):
    ...
    imgMaxContrastGrayscale, imgBlackHat, imgTopHat = maximizeContrast(imgGrayscale)
   ...
   # Trả về ảnh grayscale, ảnh nhị phân, và các ảnh TopHat, BlackHat để hiển thị
    return imgGrayscale, imgThresh, imgTopHat, imgBlackHat
...
def maximizeContrast(imgGrayscale):
    ...
    return imgGrayscalePlusTopHatMinusBlackHat,imgBlackHat,imgTopHat
# end function
